    ...
    <main>
      ...
      <section className="bg-slate-50 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-10 rounded-3xl border border-slate-200/6 0 shadow-sm max-w-4xl mx-auto mb-20 flex flex-col md:flex-row gap-8 items-start hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
